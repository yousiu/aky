...
<body ng-controller="app">
	...
	<div id="floating-panel">
		<input id="address" type="textbox" class="textbox"
			placeholder="小伝馬町, 東京"> <input id="submit" type="button"
			value="検索開始" class="button" onclick="deleteMarkers();history()">
	</div>
	<div id="map"></div>
	...
	<div class="wrap">
		<div class="form-inline">
			...
			<p>
				<input type="text" class="form-control" placeholder="例: 1000014"
					ng-model="code" ng-change="input()">
			</p>
		...
		<div ng-repeat="address in data.addresses">
			...
			<div class="content">
				<label>都道府県</label> <span class="content_form"> {{
					address.ja.prefecture }} </span>
			</div>
			<div class="content">
				<label>市区町村</label> <span class="content_form"> {{
					address.ja.address1 }} </span>
			</div>
		</div>
  ...
  function createMarkers(places) {
   ...
   // console.log(name);
	...
	.controller('app', ['$scope', 'getAddress', function ($scope, getAddress) {
		...
		<script
			src="https://maps.googleapis.com/maps/api/js?key=YOUR_API_KEY&callback&libraries=places&callback=initMap"
			async defer></script>
</body>
</html>