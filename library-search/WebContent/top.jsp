...
<body class="">
	<div class="container">
		...
		<br>
		<h1>
			<span class="badge badge-secondary">${account.userName} </span>さん
		</h1>
		...
		<div id="content">
			...
			<div id="library">
				<h3>
					選択している図書館: <strong id="pref_name"></strong><span id="systemID"
						class="badge badge-secondary">${account.system_ID} </span>
				</h3>
				<br>
				<!-- 
                                        <div id ="select-lib">
				...
				<div class="btn-group" role="group" aria-label="Basic example">
					<button type="button" class="btn btn-outline-info">
						<a href="javascript:city_selector.showDlg();" class="alert-link">別の市町村から図書館を選択</a>
					</button>
			...
			<button type="submit" class="btn btn-warning">
				<a href="book-registration.do">本を登録</a>
			</button>
			<button type="submit" class="btn btn-warning">
				<a href="book-delete">本の登録を解除</a>
			</button>
			<button type="submit" class="btn btn-warning">
				<a href="map-after.jsp">マップを見る</a>
			</button>
			...
			<!-- 結果の表示 -->
			<div id="calil_booklist" class="clearfix" value="" sytle="table"></div>
        ...
        var systemid_list = systemID.innerHTML;
        var book = new Array();
        //a 市町村選択時に実行される関数
